package com.koghi.nodo.transversales.tos.srvIntTransvOperacion;
...
public class TOOperacion {
	...
	public ArrayList<TORol> getRoles() {
		return roles;
	}
	public void setRoles(ArrayList<TORol> roles) {
		this.roles = roles;
	}
}
