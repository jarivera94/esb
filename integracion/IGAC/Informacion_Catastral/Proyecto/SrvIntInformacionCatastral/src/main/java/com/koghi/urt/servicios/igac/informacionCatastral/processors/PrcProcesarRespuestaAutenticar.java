...
import com.koghi.urt.servicios.igac.srvIntInformacionCatastral.modelo.DecodificadorBase64;
...
public class PrcProcesarRespuestaAutenticar implements Processor {
	...
	public void process (Exchange ex) throws Exception {
		...
		String user = "";
		if (estaAutenticado) {
			String authorization = ex.getIn().getHeader("Authentication").toString();
