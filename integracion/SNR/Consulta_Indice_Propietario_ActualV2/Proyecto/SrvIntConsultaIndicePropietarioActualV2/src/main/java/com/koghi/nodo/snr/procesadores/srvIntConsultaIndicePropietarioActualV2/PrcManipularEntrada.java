package com.koghi.nodo.snr.procesadores.srvIntConsultaIndicePropietarioActualV2;
...
import com.koghi.nodo.snr.util.srvIntConsultaIndicePropietarioActualV2.LectorArchivoPropiedades;
...
public class PrcManipularEntrada implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		default:
			...
			jsonEntrada.put("sistemaUsuario", exchange.getIn().getHeader("SistemaUsuario", String.class));
