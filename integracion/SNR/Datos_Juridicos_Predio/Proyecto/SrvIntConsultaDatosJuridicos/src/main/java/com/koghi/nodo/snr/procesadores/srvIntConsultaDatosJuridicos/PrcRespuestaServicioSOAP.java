...
public class PrcRespuestaServicioSOAP implements Processor {
	...
	public void process (Exchange ex) throws Exception {
		...
		jsonRespuesta = jsonRespuesta.has("ns0:consultaEstadoJuridicoResponse") ? jsonRespuesta.getJSONObject("ns0:consultaEstadoJuridicoResponse") : 
						jsonRespuesta.getJSONObject("ns2:consultaEstadoJuridicoResponse");
